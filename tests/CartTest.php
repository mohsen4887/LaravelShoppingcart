...
namespace Wschool\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use Wschool\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use Wschool\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Wschool\Shoppingcart\ShoppingcartServiceProvider;
use Wschool\Tests\Shoppingcart\Fixtures\ProductModel;
use Wschool\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Wschool\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Wschool\Shoppingcart\Exceptions\UnknownModelException
    ...
    /**
     * @test
     * @expectedException \Wschool\Shoppingcart\Exceptions\CartAlreadyStoredException
     ...
     *
     * @return \Wschool\Shoppingcart\Cart
     */
